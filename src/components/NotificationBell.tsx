...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={handleOpen} className="relative text-slate-600">
        🔔
        {unreadCount > 0 && (
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 bg-white border rounded shadow-lg max-h-96 overflow-y-auto z-10">
